...
class LeapYearTest extends TestCase
{
    ...
    /** @test */
    public function given_300_then_return_is_not_leap(): void
    {
        $result = LeapYear::isLeapYear(300);

        self::assertEquals(false, $result);
    }

    /** @test */
    public function given_500_then_return_is_not_leap(): void
    {
        $result = LeapYear::isLeapYear(500);

        self::assertEquals(false, $result);
    }

    /** @test */
    public function given_600_then_return_is_not_leap(): void
    {
        $result = LeapYear::isLeapYear(600);
